...
public class BluetoothChatService {
	...
	public static BluetoothChatService createInstance(Context context, Handler handler){
		if(instance == null)
    ...
    private static final String NAME = "BluetoothSMS";
    ...
    public BluetoothChatService(Context context, Handler handler) {
		...
		if(prefs.getBoolean("enabled", true)){
			...
			//Message Receiver
	        context.registerReceiver(receiver, new IntentFilter(RECEIVED_ACTION));
	        //MMS Receiver
			...
			context.registerReceiver(receiver, tmp);
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BluetoothSms.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(BluetoothSms.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothSms.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothSms.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothSms.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothSms.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothSms.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    public void handleSmsReceive(Intent in){
		...
		if(bundle!=null)
		{
			...
			for(SmsMessage message: messages){
				...
				mes = new TextMessage(sender,time,body, TextMessage.RECEIVED);
			}
			Log.v("Message from "+sender);
			//Send it!
			//TODO: Send it here
			mConnectedThread.write(mes.bytes());
		}
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            try {
                tmp = mAdapter.listenUsingRfcommWithServiceRecord(NAME, Utils.UUID);
            } catch (IOException e) {
        ...
        public void run() {
            if (D) Log.d("BEGIN mAcceptThread" + this);
            ...
            if (D) Log.i("END mAcceptThread");
        }

        public void cancel() {
            if (D) Log.d("cancel " + this);
            try {
                mmServerSocket.close();
            } catch (IOException e) {
                Log.e("close() of server failed", e);
            }
        }
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                tmp = device.createRfcommSocketToServiceRecord(Utils.UUID);
            } catch (IOException e) {
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(BluetoothSms.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BluetoothSms.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
